...
<?php             
            ...
            <tr>                
                ...
                <td> <?php if($order_status=='Terbayar'){
                   echo  "<a href='../rating/rating.php?order_id=$order_id' target='_blank' class='btn btn-info btn-sm'> Masukkan Review </a>";
                }else{
                    echo 'Sudah melakukan pembayaran';
                }
                ?></td>            
...
<body>
    <div class="container">
    	...
    	<div class="card">
    		<div class="card-header"><?php echo $product_title; ?></div>
    		<div class="card-body">
    			<div class="row">
