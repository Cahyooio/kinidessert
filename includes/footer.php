        ...
        <div class="row"><!-- row Begin -->
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
               ...
               <h4>Tentang Kami</h4>
                ...
                <ul><!-- ul Begin -->
                <li><a href="https://instagram.com/kinidessert" class="fa fa-instagram"> Kinidessert</a></li>
            ...
            <div class="com-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
                ...
                <ul><!-- ul Begin -->
                <li><a href="customer/my_account.php?pay_offline">Cara Pembayaran</a></li>
...
<div id="copyright"><!-- #copyright Begin -->
    <div class="container"><!-- container Begin -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <p class="pull-left">&copy; 2021 Kinidessert.</p>
